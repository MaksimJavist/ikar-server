...
public final class Messages {
    ...
    public static final String CREATION_MESSAGE_DIGEST_MESSAGE = "Ошибка при создании шифратора";
    ...
    public static final String CONFERENCE_PRESENTER_BUSY = "В настоящее время презентующим выступает другой пользователь.";
    public static final String CONFERENCE_DOES_NOT_PRESENTER = "Вы не являетесь презентующим";
    public static final String CONFERENCE_NOT_ACTIVE_PRESENTER = "Сейчас нет активного презентующего.";
